...
// For openning modal
var btn = document.getElementsByClassName("anime-more");
for (var i = 0; i < btn.length; i++) {
    var thisBtn = btn[i];
    thisBtn.addEventListener("click", function(){
        var modal = document.getElementById(this.dataset.modal);
...
// For closing modal with (x)
var span = document.getElementsByClassName("e-cancel");
for (var i = 0; i < span.length; i ++) {
    var thisSpan = span[i];
    thisSpan.addEventListener("click", function(){
        var modal = document.getElementById(this.dataset.modal);
...
// For closing modal by clicking outside
var modals = document.getElementsByClassName("editModal")
for (var i = 0; i < modals.length; i ++) {
    let thisModal = modals[i];
    thisModal.addEventListener("click", function(e){
        console.log(thisModal)
